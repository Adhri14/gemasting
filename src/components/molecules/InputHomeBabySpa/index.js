...
const InputHomeBabySpa = () => {
  ...
  const updateProfile = () => {
    ...
    if (photoReducer.name === '' && documentReducer.name === '') {
      axios
        .put(`${API}hbs/update-profile`, profile, {
        ...
        .then(resUpload => {
          ...
          axios
            ...
            .then(resFile => {
              ...
              axios
                .put(`${API}hbs/update-profile`, data, {
                  headers: {Authorization: token.value},
                })
                .then(res => {
                  storeData('userProfile', res.data.data);
  ...
  return (
    <View>
      ...
      <TextInput
        type="secondary"
        label="Nama Kantor HomeBaby Spa"
        placeholder="Nama"
        value={profile.name}
      ...
      <TextInput
        type="secondary"
        label="Alamat Kantor HomeBaby Spa"
      ...
      <Gap height={35} />
      <FileUpload
        label="Upload Surat Keterangan LSP"
        onPress={addDocument}
